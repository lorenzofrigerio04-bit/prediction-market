  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[16/10] overflow-hidden">
        ...
        {/* Countdown or live pill — top right */}
      ...
      <div className="flex flex-1 flex-col gap-1.5 p-2.5 sm:p-3">
        ...
        {/* Secondary info: credits + division */}
        <div className="mt-1 flex items-center justify-between text-[9px] text-white/28">
          <span className="font-numeric tabular-nums">
            {event.totalCredits > 0
              ? `${event.totalCredits.toLocaleString("it-IT")} Ꝓ`
              : "—"}
          </span>
          <span className="uppercase tracking-[0.07em]">{event.category}</span>
        </div>
      </div>
    </Link>
  );
