  ...
  return (
    <article className="box-raised rounded-3xl p-6 md:p-8 border border-border/70 bg-admin-bg">
      ...
      <div className="prose prose-sm max-w-none text-fg space-y-6">
        <section>
          <h2 className="font-kalshi text-[1.25rem] font-bold text-fg leading-[1.06] tracking-[0.01em] mb-2">1. Dati raccolti</h2>
        ...
        <section>
          <h2 className="font-kalshi text-[1.25rem] font-bold text-fg leading-[1.06] tracking-[0.01em] mb-2">2. Base giuridica</h2>
          <p className="text-fg-muted leading-relaxed">
        ...
        <section>
          <h2 className="font-kalshi text-[1.25rem] font-bold text-fg leading-[1.06] tracking-[0.01em] mb-2">3. Diritti dell&apos;utente (GDPR)</h2>
          <p className="text-fg-muted leading-relaxed">
        ...
        <section>
          <h2 className="font-kalshi text-[1.25rem] font-bold text-fg leading-[1.06] tracking-[0.01em] mb-2">4. Conservazione e sicurezza</h2>
          <p className="text-fg-muted leading-relaxed">
