  ...
  return (
    <div className="min-h-[50vh] flex flex-col items-center justify-center px-4 py-12 bg-bg">
      ...
      <div className="flex gap-3">
        ...
        <a
          href="/"
          className="px-4 py-2 glass border border-border dark:border-white/10 text-fg rounded-2xl hover:border-primary/20 focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-bg"
        >
          Torna alla home
        </a>
      </div>
