...
import { ABUSE_RISK_FLAG_SCHEMA_ID, ADMIN_CREDIT_ADJUSTMENT_SCHEMA_ID, BONUS_ELIGIBILITY_SCHEMA_ID, CREDIT_BALANCE_SNAPSHOT_SCHEMA_ID, CREDIT_CONSUMPTION_EVENT_SCHEMA_ID, CREDIT_GRANT_SCHEMA_ID, CREDIT_LEDGER_ENTRY_SCHEMA_ID, CREDITS_COMPATIBILITY_VIEW_SCHEMA_ID, createAbuseRiskFlag, createAbuseRiskFlagId, createCorrelationId, createCreditLedgerEntry, createCreditLedgerEntryId, createOwnerRef, createRelatedRef, createVersion, createVirtualCreditAccountId, DeterministicAbuseRiskEvaluator, DeterministicBalanceSnapshotBuilder, LedgerEntryType, QUOTA_EVALUATION_SCHEMA_ID, QUOTA_POLICY_SCHEMA_ID, RiskSeverity, RiskType, USAGE_COUNTER_SCHEMA_ID, validateCreditAuditChain, validateVirtualCreditsFamilyAggregate, VIRTUAL_CREDIT_ACCOUNT_SCHEMA_ID, } from "../../src/virtual-credits/index.js";
...
describe("virtual-credits hardening", () => {
    ...
    it("ledger audit chain catches missing correlation id", () => {
        ...
        const report = validateCreditAuditChain([{ ...entry, correlation_id: "" }]);
...
//# sourceMappingURL=virtual-credits-hardening.spec.js.map