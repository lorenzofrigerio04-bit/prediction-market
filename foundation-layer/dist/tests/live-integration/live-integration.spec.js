...
import { ActivationPolicy, ArtifactType, ComplianceFlag, ContractStatus, MarketVisibility, DeterministicDeliveryReadinessEvaluator, DeterministicLiveContractBuilder, DeterministicPublicationHandoffManager, DeterministicPublicationPackager, DeterministicSchedulingPreparer, HandoffStatus, PackageStatus, ReadinessStatus, SchedulingStatus, createDeliveryReadinessReport, createLivePublicationContract, createPublicationArtifact, createPublicationHandoff, createPublicationMetadata, createPublicationPackage, createSchedulingCandidate, createSchedulingWindow, validateDeliveryReadinessReport, validateLiveIntegrationPipeline, validateLivePublicationContract, validatePublicationHandoff, validatePublicationPackage, validateSchedulingCandidate, DELIVERY_READINESS_REPORT_SCHEMA_ID, LIVE_PUBLICATION_CONTRACT_SCHEMA_ID, PUBLICATION_ARTIFACT_SCHEMA_ID, PUBLICATION_HANDOFF_SCHEMA_ID, PUBLICATION_METADATA_SCHEMA_ID, PUBLICATION_PACKAGE_SCHEMA_ID, SCHEDULING_CANDIDATE_SCHEMA_ID, SCHEDULING_WINDOW_SCHEMA_ID, } from "../../src/live-integration/index.js";
...
import { createApprovalDecisionId, createEditorialActorId, createPublicationReadyArtifactId, } from "../../src/editorial/value-objects/editorial-ids.vo.js";
...
const makePublicationReadyArtifact = () => createPublicationReadyArtifact({
...
const makePublicationMetadata = () => createPublicationMetadata({
    category: "macro",
    tags: ["rates", "fed"],
    jurisdiction: "US",
    display_priority: 1,
...
const makePublicationPackage = () => createPublicationPackage({
    id: "ppkg_live0001",
    version: "1.0.0",
...
const makeReadinessReport = () => createDeliveryReadinessReport({
    id: "drrp_live0001",
...
const makeSchedulingCandidate = () => createSchedulingCandidate({
    id: "scnd_live0001",
    publication_package_id: "ppkg_live0001",
...
const makeHandoff = () => createPublicationHandoff({
    id: "phnd_live0001",
    version: "1.0.0",
    publication_package_id: "ppkg_live0001",
...
const makeLiveContract = () => createLivePublicationContract({
    id: "lpct_live0001",
    version: "1.0.0",
    publication_package_id: "ppkg_live0001",
...
describe("live-integration module", () => {
    ...
    it("rejects PublicationHandoff without audit linkage", () => {
        const invalid = { ...makeHandoff(), audit_ref: "" };
...
//# sourceMappingURL=live-integration.spec.js.map