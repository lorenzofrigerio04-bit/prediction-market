...
import { applyTransition, createInitialWorkflowTransition, } from "@/workflow/foundation-workflow.machine.js";
...
describe("foundation-layer integration flow", () => {
    it("constructs and validates full domain chain in memory", () => {
        ...
        const canonicalEvent = createCanonicalEvent({
            ...
            resolutionWindow: createResolutionWindow("2026-03-01T08:00:00.000Z", "2026-03-31T23:59:59.000Z"),
            entityVersion: createEntityVersion(),
        });
...
//# sourceMappingURL=foundation-layer.spec.js.map