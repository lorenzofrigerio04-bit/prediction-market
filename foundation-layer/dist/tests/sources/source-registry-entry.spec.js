...
import { AuthenticationMode, SourceHealthStatus, createAuditMetadata, createSourceDefinitionId, createSourceRegistryEntry, createTimestamp, validateSourceRegistryEntry, } from "@/index.js";
const createValidRegistryEntry = () => createSourceRegistryEntry({
...
describe("source registry entry", () => {
    ...
    it("rejects invalid authentication mode", () => {
        ...
        const report = validateSourceRegistryEntry(payload);
...
//# sourceMappingURL=source-registry-entry.spec.js.map