...
import { EvidenceSpanKind, IdentifierKind, LanguageCoverageMode, NormalizationStatus, ParseStrategy, ResolutionEligibility, SourceClass, SourceReferenceKind, SourceUseCase, createEntityVersion, createEvidenceSpan, createFreshnessProfile, createJurisdictionCandidate, createLanguageCoverage, createLanguageCode, createObservationConfidenceScore, createRawPayloadReference, createReliabilityProfile, createSourceBaseIdentifier, createSourceDefinition, createSourceDefinitionId, createSourceObservation, createSourceObservationId, createSourceReference, createTimestamp, createTraceabilityMetadata, validateSourceObservation, } from "@/index.js";
...
describe("source observation", () => {
    ...
    it("invalid SourceObservation without traceability fields", () => {
        ...
        const report = validateSourceObservation(payload);
...
//# sourceMappingURL=source-observation.spec.js.map