...
const makeOutcome = (id, key, label) => createOutcomeDefinition({
...
const makeValidAdvancedOutcomeResult = () => createAdvancedOutcomeGenerationResult({
...
describe("AdvancedOutcomeGenerationResult", () => {
    ...
    it("rejects non-frontier contract type for advanced outcomes", () => {
        expect(() => createAdvancedOutcomeGenerationResult({
            ...makeValidAdvancedOutcomeResult(),
            contract_type: ContractType.BINARY,
        })).toThrow();
    });
});
//# sourceMappingURL=advanced-outcome-generation-result.spec.js.map