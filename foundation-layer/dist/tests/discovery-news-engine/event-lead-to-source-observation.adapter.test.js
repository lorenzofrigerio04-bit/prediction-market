...
import { eventLeadToSourceObservationAdapter, createEventLead, createEventLeadId, createDiscoveryStoryClusterId, createEventLeadEvidenceSet, createEventLeadReason, EventLeadStatus, EventLeadReadiness, EventLeadConfidence, } from "../../src/discovery-news-engine/index.js";
...
function makeLead(overrides = {}) {
    ...
    const evidenceSet = createEventLeadEvidenceSet({
        ...
        ...(overrides.memberSignalIds != null && overrides.memberSignalIds.length > 0
            ? { memberSignalIds: overrides.memberSignalIds }
            : {}),
    });
...
//# sourceMappingURL=event-lead-to-source-observation.adapter.test.js.map