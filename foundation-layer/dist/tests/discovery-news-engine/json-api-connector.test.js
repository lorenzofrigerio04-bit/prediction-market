...
import { jsonApiConnector, jsonApiNormalizationAdapter, runConnectorWithNormalize, normalizeJsonApiPayload, createDiscoveryFetchRequest, createDiscoverySourceDefinition, createDiscoverySourceId, createDiscoverySourceKey, createDiscoverySourceEndpoint, createDiscoveryFetchedPayload, createDiscoveryTransportMetadata, DiscoverySourceKind, DiscoveryContentType, DiscoverySourceStatus, DiscoveryPollingHint, DiscoveryGeoScope, DiscoveryTopicScope, DiscoveryTrustTier, DiscoverySourceAuthMode, DiscoverySourceTier, } from "../../src/discovery-news-engine/index.js";
...
describe("jsonApiConnector", () => {
    ...
    it("fetch returns payload for valid JSON with articles array", async () => {
        ...
        if (response.ok) {
            ...
            const articles = response.payload.raw.articles;
    ...
    it("runConnectorWithNormalize returns success with normalized items", async () => {
        ...
        const result = await runConnectorWithNormalize(request, jsonApiConnector, jsonApiNormalizationAdapter);
...
describe("json-api normalizer", () => {
    ...
    it("normalizeJsonApiPayload throws when raw has no items array", () => {
        ...
        expect(() => normalizeJsonApiPayload(payload, {
            sourceDefinition: apiSourceDefinition,
            runIdNullable: null,
...
//# sourceMappingURL=json-api-connector.test.js.map