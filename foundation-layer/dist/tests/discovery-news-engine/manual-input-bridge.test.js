...
import { manualInputBridgeConnector, runConnectorWithNormalize, jsonApiNormalizationAdapter, createDiscoveryFetchRequest, createDiscoverySourceDefinition, createDiscoverySourceId, createDiscoverySourceKey, createDiscoverySourceEndpoint, DiscoverySourceKind, DiscoverySourceTier, DiscoverySourceStatus, DiscoveryPollingHint, DiscoveryGeoScope, DiscoveryTopicScope, DiscoveryTrustTier, DiscoverySourceAuthMode, } from "../../src/discovery-news-engine/index.js";
...
describe("manualInputBridgeConnector", () => {
    ...
    it("fetch returns success and runConnectorWithNormalize returns success for valid items array", async () => {
        ...
        if (response.ok) {
            ...
            expect(response.payload.raw.items).toHaveLength(2);
        }
        const runResult = await runConnectorWithNormalize(request, manualInputBridgeConnector, jsonApiNormalizationAdapter);
...
//# sourceMappingURL=manual-input-bridge.test.js.map