...
import { discoveryDedupeEvaluator, createNormalizedDiscoveryItem, createNormalizedSourceReference, createDiscoverySourceId, createDiscoverySourceKey, createDiscoveryDedupeKey, DiscoveryDedupeOutcome, DiscoveryDedupeReason, DiscoveryDedupeEvidenceStrength, createDiscoverySignal, createDiscoverySignalId, createDiscoverySignalTimeWindow, createDiscoveryProvenanceMetadata, createDiscoverySignalEvidenceRef, DiscoverySignalKind, DiscoverySignalStatus, DiscoverySignalFreshnessClass, DiscoverySignalPriorityHint, DiscoveryEvidenceRole, DiscoverySourceTier, DiscoveryTrustTier, deriveDedupeKeysFromItem, } from "../../src/discovery-news-engine/index.js";
...
describe("discoveryDedupeEvaluator", () => {
    describe("evaluateItem", () => {
        ...
        it("within-run incremental: 10 distinct items each with only prior items in withinRunItems all evaluate to UNIQUE", () => {
            const tenItems = Array.from({ length: 10 }, (_, i) => item({
...
//# sourceMappingURL=dedupe-evaluator.test.js.map