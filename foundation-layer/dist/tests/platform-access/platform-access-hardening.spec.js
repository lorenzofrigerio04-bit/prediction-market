...
import { ACCESS_SCOPE_SCHEMA_ID, ACTION_PERMISSION_CHECK_SCHEMA_ID, ADMIN_CAPABILITY_FLAG_SCHEMA_ID, AUTHORIZATION_DECISION_SCHEMA_ID, PERMISSION_POLICY_SCHEMA_ID, PLATFORM_ACTION_COMPATIBILITY_SCHEMA_ID, ROLE_ASSIGNMENT_SCHEMA_ID, ROLE_DEFINITION_SCHEMA_ID, USER_IDENTITY_SCHEMA_ID, WORKSPACE_SCHEMA_ID, createCapabilityFlagKey, createUserIdentityId, DeterministicCapabilityPolicyAdapter, } from "../../src/platform-access/index.js";
...
describe("platform-access hardening requirements", () => {
    ...
    it("22 - enforces sensitive capability safety by validator and adapter", () => {
        ...
        const report = validateAdminCapabilityFlag(createAdminCapabilityFlag({
            flag_key: capability,
...
//# sourceMappingURL=platform-access-hardening.spec.js.map