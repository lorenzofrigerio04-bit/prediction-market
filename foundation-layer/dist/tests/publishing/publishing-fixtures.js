...
import { createActionReference, createSubjectReference, createTemporalWindow, } from "@/event-intelligence/value-objects/shared-domain.vo.js";
import { createCanonicalEventIntelligenceId, createEventCandidateId, createEventClusterId, } from "@/event-intelligence/value-objects/event-intelligence-ids.vo.js";
import { createSourceObservationId } from "@/observations/value-objects/source-observation-id.vo.js";
import { createClaimId, createConfidenceScore, createDescription, createEventId, createResolutionWindow, createSlug, createTag, createTitle, } from "@/index.js";
...
import { createContractSelectionId, createDeadlineResolutionId, createOpportunityAssessmentId, createOutcomeGenerationResultId, createSourceHierarchySelectionId, } from "@/market-design/value-objects/market-design-ids.vo.js";
...
export const makeMarketDraftPipeline = () => {
    ...
    const foundationCandidateMarket = candidateMarketFactory({
        ...
        resolutionWindow: createResolutionWindow("2026-07-01T10:00:00.000Z", "2026-08-01T10:00:00.000Z"),
        categories: ["macro"],
...
//# sourceMappingURL=publishing-fixtures.js.map