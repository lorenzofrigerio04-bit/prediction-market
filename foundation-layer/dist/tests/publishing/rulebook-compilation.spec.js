...
describe("RulebookCompilation", () => {
    ...
    it("rejects compilation missing required section", () => {
        ...
        expect(() => createRulebookCompilation({
            ...validCompilation,
            compilation_status: CompilationStatus.INCOMPLETE,
            included_sections: validCompilation.included_sections.filter((section) => section.section_type !== "TIME_POLICY"),
        })).toThrow();
    });
...
//# sourceMappingURL=rulebook-compilation.spec.js.map