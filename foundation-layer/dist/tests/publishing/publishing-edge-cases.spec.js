...
describe("Publishing edge cases", () => {
    ...
    it("rejects invalid structural readiness score range", () => {
        expect(() => createPublishableCandidate({
            id: "pcnd_validcand01",
            version: createEntityVersion(1),
            market_draft_pipeline_id: "mdp_validpipe001",
            title_set_id: "tset_validtitle01",
            resolution_summary_id: "rsum_validsum001",
            rulebook_compilation_id: "rbcmp_validcomp01",
...
//# sourceMappingURL=publishing-edge-cases.spec.js.map