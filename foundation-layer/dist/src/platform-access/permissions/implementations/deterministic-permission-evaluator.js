...
const scopeSatisfiesConstraint = (scope, constraint) => {
...
const isScopeAllowedByPolicy = (scope, policyInput) => {
...
export class DeterministicPermissionEvaluator {
    evaluate(input) {
        const reasons = [];
...
//# sourceMappingURL=deterministic-permission-evaluator.js.map