...
function sanitizeFeedBody(body) {
    return body
        .replace(/\0/g, "")
        .replace(/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F]/g, " ");
}
async function parseFeedBody(body) {
...
export const feedConnector = {
    canHandle(definition) {
        return (definition.kind === DiscoverySourceKind.RSS || definition.kind === DiscoverySourceKind.FEED);
    },
    async fetch(request) {
...
//# sourceMappingURL=feed-connector.js.map