...
function validateManualPayload(raw) {
    const failures = [];
    let items = [];
    if (Array.isArray(raw.items) && raw.items.length > 0) {
        ...
        failures.push(createDiscoveryValidationFailure({
            code: "INVALID_SHAPE",
            path: "",
...
export const manualInputBridgeConnector = {
...
//# sourceMappingURL=manual-input-bridge.js.map