...
import { createEventLeadObservationConversionResult, } from "./event-lead-observation-conversion-result.entity.js";
...
function observationIdFromLeadId(leadId) {
...
export const eventLeadToSourceObservationAdapter = {
    convert(lead) {
        ...
        const hasSignalEvidence = lead.evidenceSet.memberSignalIds != null &&
        ...
        const headline = lead.evidenceSet.representativeHeadlineNullable?.trim() ||
        ...
        for (let i = 0; i < lead.evidenceSet.memberItemIds.length; i++) {
            ...
            evidenceSpans.push(createEvidenceSpan({
...
//# sourceMappingURL=event-lead-to-source-observation.adapter.js.map