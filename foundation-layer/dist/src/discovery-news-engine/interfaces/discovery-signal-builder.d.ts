...
export type DiscoverySignalBuildInput = NormalizedDiscoveryItem | NormalizedDiscoveryPayload;
...
export interface DiscoverySignalBuilder {
    build(input: DiscoverySignalBuildInput, options?: DiscoverySignalBuildOptions): DiscoverySignal | readonly DiscoverySignal[];
}
//# sourceMappingURL=discovery-signal-builder.d.ts.map