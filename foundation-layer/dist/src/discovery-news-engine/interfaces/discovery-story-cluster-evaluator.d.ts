...
export interface DiscoveryStoryClusterEvaluator {
     ...
     */
    assignToClusters(input: DiscoveryStoryClusterAssignInput, context: DiscoveryStoryClusterContext): DiscoveryStoryClusterAssignResult;
}
//# sourceMappingURL=discovery-story-cluster-evaluator.d.ts.map