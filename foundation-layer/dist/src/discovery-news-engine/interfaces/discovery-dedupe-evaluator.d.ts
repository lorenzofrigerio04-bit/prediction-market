...
import type { DiscoveryDedupeDecision, DiscoveryDedupeDecisionV1 } from "../entities/discovery-dedupe-decision.entity.js";
...
export interface DiscoveryDedupeEvaluator {
    evaluate(key: DiscoveryDedupeKey, candidate: unknown, context: DiscoveryDedupeContext): DiscoveryDedupeDecision;
    evaluateItem(candidate: NormalizedDiscoveryItem, context: DiscoveryDedupeContextV1): DiscoveryDedupeDecisionV1;
    evaluateSignal(candidate: DiscoverySignal, context: DiscoveryDedupeContextV1): DiscoveryDedupeDecisionV1;
}
//# sourceMappingURL=discovery-dedupe-evaluator.d.ts.map