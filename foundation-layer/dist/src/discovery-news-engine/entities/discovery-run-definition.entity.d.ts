...
export declare const createDiscoveryRunDefinition: (input: DiscoveryRunDefinition) => DiscoveryRunDefinition;
//# sourceMappingURL=discovery-run-definition.entity.d.ts.map