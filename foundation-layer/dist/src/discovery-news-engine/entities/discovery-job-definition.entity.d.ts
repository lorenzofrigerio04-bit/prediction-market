...
export declare const createDiscoveryJobDefinition: (input: DiscoveryJobDefinition) => DiscoveryJobDefinition;
//# sourceMappingURL=discovery-job-definition.entity.d.ts.map