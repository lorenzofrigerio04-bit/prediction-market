...
export class DeterministicMarketRelationshipBuilder {
    build(input) {
        const relationships = [
        ...
        return relationships.map((relation, index) => {
            const token = createDeterministicToken(`${relation.source_market_ref}|${relation.target_market_ref}|${index}`);
...
//# sourceMappingURL=deterministic-market-relationship-builder.js.map