...
export interface FamilyCompatibilityAdapter {
    adapt(family: MarketFamily, validation_report?: ExpansionValidationReport): MarketFamilyCompatibilityResult;
}
//# sourceMappingURL=family-compatibility-adapter.d.ts.map