...
export class DeterministicDerivativeMarketGenerator {
    generate(input) {
        if (input.candidate_markets.length === 0) {
            throw new ValidationError("DERIVATIVE_GENERATION_FAILED", "candidate_markets must include at least one market");
        }
...
//# sourceMappingURL=deterministic-derivative-market-generator.js.map