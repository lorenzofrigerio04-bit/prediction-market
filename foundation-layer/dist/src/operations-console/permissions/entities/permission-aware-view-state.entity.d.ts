...
export declare const createPermissionAwareViewState: (input: PermissionAwareViewState) => PermissionAwareViewState;
//# sourceMappingURL=permission-aware-view-state.entity.d.ts.map