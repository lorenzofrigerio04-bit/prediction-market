...
export declare const createArtifactInspectionView: (input: ArtifactInspectionView) => ArtifactInspectionView;
//# sourceMappingURL=artifact-inspection-view.entity.d.ts.map