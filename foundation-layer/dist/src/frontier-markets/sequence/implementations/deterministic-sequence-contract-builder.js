...
const sortTargetsDeterministically = (input) => [...input.sequence_targets].sort((left, right) => left.target_key.localeCompare(right.target_key));
export class DeterministicSequenceContractBuilder {
    build(input) {
...
//# sourceMappingURL=deterministic-sequence-contract-builder.js.map