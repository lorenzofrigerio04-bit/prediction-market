...
import { createJurisdictionCode, } from "../../value-objects/jurisdiction-code.vo.js";
import { createPublicationTag } from "../../value-objects/publication-tag.vo.js";
export const createPublicationMetadata = (input) => {
    ...
    if (!Number.isInteger(input.display_priority) || input.display_priority < 0) {
        throw new ValidationError("INVALID_PUBLICATION_METADATA", "display_priority must be a non-negative integer");
    }
...
//# sourceMappingURL=publication-metadata.entity.js.map