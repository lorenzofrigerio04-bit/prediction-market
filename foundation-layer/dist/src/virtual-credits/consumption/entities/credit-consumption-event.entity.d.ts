...
import type { ActionKey, CreditConsumptionEventId, Note, RelatedRef, Version, VirtualCreditAccountId } from "../../value-objects/index.js";
...
export declare const createCreditConsumptionEvent: (input: CreditConsumptionEvent) => CreditConsumptionEvent;
//# sourceMappingURL=credit-consumption-event.entity.d.ts.map