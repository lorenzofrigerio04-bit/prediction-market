...
export declare const createCreditsCompatibilityView: (input: CreditsCompatibilityView) => CreditsCompatibilityView;
//# sourceMappingURL=credits-compatibility-view.entity.d.ts.map