...
export const createLanguageCoverage = (input) => {
    if (input.mode === LanguageCoverageMode.EXPLICIT_LIST && input.languages.length === 0) {
        throw new ValidationError("INVALID_LANGUAGE_COVERAGE", "languages must be non-empty when mode is EXPLICIT_LIST");
    }
...
//# sourceMappingURL=language-coverage.vo.js.map