...
import type {
  ...
  CannibalizationCheckerInput,
} from "../interfaces/cannibalization-checker.js";
import { createCannibalizationCheckResultId } from "../../value-objects/market-expansion-ids.vo.js";

export class DeterministicCannibalizationChecker implements CannibalizationChecker {
  check(input: CannibalizationCheckerInput) {
