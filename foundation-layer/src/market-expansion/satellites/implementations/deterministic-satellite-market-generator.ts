...
import type {
  SatelliteMarketGenerator,
  SatelliteMarketGeneratorInput,
} from "../interfaces/satellite-market-generator.js";
import { createSatelliteMarketDefinitionId } from "../../value-objects/market-expansion-ids.vo.js";

const ROLE_ORDER: readonly SatelliteRole[] = [
  SatelliteRole.HEDGE,
...
export class DeterministicSatelliteMarketGenerator implements SatelliteMarketGenerator {
  generate(input: SatelliteMarketGeneratorInput) {
