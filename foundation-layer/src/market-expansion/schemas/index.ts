...
export const marketExpansionSchemas = [
  marketFamilySchema,
  flagshipMarketSelectionSchema,
  satelliteMarketDefinitionSchema,
  derivativeMarketDefinitionSchema,
  marketRelationshipSchema,
  expansionStrategySchema,
  cannibalizationCheckResultSchema,
  expansionValidationReportSchema,
  familyGenerationResultSchema,
  marketFamilyCompatibilityResultSchema,
] as const;
