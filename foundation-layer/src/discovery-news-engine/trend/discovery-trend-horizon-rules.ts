...
export function evaluateFastPulseRule(
  indicators: DiscoveryTrendIndicatorSet,
): DiscoveryTrendRuleResult {
  ...
  const hasAttentionOrEditorial =
    indicators.hasEditorialSource || indicators.hasAttentionSource;
...
export function evaluateShortCycleRule(
  indicators: DiscoveryTrendIndicatorSet,
): DiscoveryTrendRuleResult {
...
export function evaluateMediumCycleRule(
  indicators: DiscoveryTrendIndicatorSet,
): DiscoveryTrendRuleResult {
...
export function evaluateScheduledMonitorRule(
  indicators: DiscoveryTrendIndicatorSet,
): DiscoveryTrendRuleResult {
...
const RULE_EVALUATORS: Readonly<
  Record<DiscoveryTrendHorizon, (i: DiscoveryTrendIndicatorSet) => DiscoveryTrendRuleResult>
> = {
...
export function evaluateHorizonRule(
