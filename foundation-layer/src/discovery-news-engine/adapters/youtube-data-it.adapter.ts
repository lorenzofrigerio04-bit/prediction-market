...
function getVideoId(item: Record<string, unknown>): string | null {
...
export const youtubeDataItNormalizationAdapter: DiscoveryNormalizationAdapter = {
  normalize(payload: DiscoveryFetchedPayload, context: DiscoveryNormalizationContext): NormalizedDiscoveryPayload {
    ...
    for (const item of itemsArray) {
      ...
      const observedMetricsNullable =
        channelId != null ? createDiscoveryObservedMetrics({ channelIdNullable: channelId }) : null;
...
export const youtubeDataItSourceAdapter: DiscoverySourceAdapter = {
