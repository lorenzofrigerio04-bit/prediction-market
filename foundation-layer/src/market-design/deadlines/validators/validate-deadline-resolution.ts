...
import type { DeadlineResolution } from "../entities/deadline-resolution.entity.js";
import { DEADLINE_RESOLUTION_SCHEMA_ID } from "../../schemas/deadline-resolution.schema.js";

const validateDeadlineResolutionInvariants = (input: DeadlineResolution): readonly ValidationIssue[] => {
...
export const validateDeadlineResolution = (
  input: DeadlineResolution,
