...
export const marketDesignSchemas = [
  opportunityAssessmentSchema,
  contractSelectionSchema,
  outcomeDefinitionSchema,
  outcomeGenerationResultSchema,
  deadlineResolutionSchema,
  sourceHierarchySelectionSchema,
  preliminaryScorecardSchema,
  marketDraftPipelineSchema,
] as const;
