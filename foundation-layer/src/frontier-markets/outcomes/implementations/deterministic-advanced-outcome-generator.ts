...
import type {
  AdvancedOutcomeGenerator,
  AdvancedOutcomeGeneratorInput,
} from "../interfaces/advanced-outcome-generator.js";
...
export class DeterministicAdvancedOutcomeGenerator implements AdvancedOutcomeGenerator {
  generate(input: AdvancedOutcomeGeneratorInput) {
