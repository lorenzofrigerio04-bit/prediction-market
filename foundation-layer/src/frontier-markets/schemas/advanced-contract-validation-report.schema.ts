...
export const ADVANCED_CONTRACT_VALIDATION_REPORT_SCHEMA_ID =
  "https://market-design-engine.dev/schemas/frontier-markets/advanced-contract-validation-report.schema.json";
