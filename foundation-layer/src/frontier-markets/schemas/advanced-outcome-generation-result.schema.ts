...
export const ADVANCED_OUTCOME_GENERATION_RESULT_SCHEMA_ID =
  "https://market-design-engine.dev/schemas/frontier-markets/advanced-outcome-generation-result.schema.json";
