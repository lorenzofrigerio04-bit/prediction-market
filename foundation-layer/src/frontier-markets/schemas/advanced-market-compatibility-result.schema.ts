...
export const ADVANCED_MARKET_COMPATIBILITY_RESULT_SCHEMA_ID =
  "https://market-design-engine.dev/schemas/frontier-markets/advanced-market-compatibility-result.schema.json";
