...
export type AdvancedContractInput =
  | Readonly<{ contract_type: ContractType.RACE; payload: RaceMarketDefinition }>
  | Readonly<{ contract_type: ContractType.SEQUENCE; payload: SequenceMarketDefinition }>
  | Readonly<{ contract_type: ContractType.CONDITIONAL; payload: ConditionalMarketDefinition }>;
