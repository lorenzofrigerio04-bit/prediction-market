...
import type {
  AdvancedContractInput,
  AdvancedContractValidator,
} from "../interfaces/advanced-contract-validator.js";
...
const toInvariantChecks = (input: AdvancedContractInput) => {
...
export class DeterministicAdvancedContractValidator implements AdvancedContractValidator {
  validate(input: AdvancedContractInput) {
