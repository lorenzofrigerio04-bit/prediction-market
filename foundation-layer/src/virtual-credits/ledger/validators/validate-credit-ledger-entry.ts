...
const validateInvariants = (input: CreditLedgerEntry): readonly ValidationIssue[] => {
...
export const validateCreditLedgerEntry = (input: CreditLedgerEntry, options?: ValidationOptions): ValidationReport => {
