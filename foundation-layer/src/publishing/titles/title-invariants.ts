...
const hasContradictoryNegation = (canonicalTitle: string, displayTitle: string): boolean => {
...
export const isCanonicalMoreFormalThanDisplay = (
  canonicalTitle: string,
  displayTitle: string,
): boolean => normalizeWhitespace(canonicalTitle).length >= normalizeWhitespace(displayTitle).length;

export const isDisplayTitleCompatible = (canonicalTitle: string, displayTitle: string): boolean => {
