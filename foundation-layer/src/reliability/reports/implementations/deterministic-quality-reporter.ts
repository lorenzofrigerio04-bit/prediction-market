...
import { createQualityReport, type QualityReport } from "../entities/quality-report.entity.js";
...
export class DeterministicQualityReporter implements QualityReporter {
