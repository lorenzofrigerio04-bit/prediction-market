...
import {
  DeterministicGovernanceCompatibilityAdapter,
  GovernanceCompatibilityContext,
  PlatformAccessAdminGovernanceCompatibilityAdapter,
  OperationsConsoleAdminGovernanceCompatibilityAdapter,
  VirtualCreditsAdminGovernanceCompatibilityAdapter,
  createGovernanceMetadata,
  createModuleKey,
  createOperationKey,
  validateAdminGovernanceCompatibilityView,
  validateGovernanceCompatibilityView,
} from "../../src/admin-governance/index.js";

describe("admin-governance compatibility adapters", () => {
  const context: GovernanceCompatibilityContext = {
