...
import {
  ...
  TargetModule,
  ThresholdStatus,
  createAdversarialCase,
  createAdversarialCaseId,
  ...
  createModuleHealthMetricId,
  createObservabilityEvent,
  createObservabilityEventId,
  createPipelineHealthSnapshot,
  createPipelineHealthSnapshotId,
  createQualityReport,
  createQualityReportId,
  createRegressionCase,
  createRegressionCaseId,
  createReleaseGateEvaluation,
  createReleaseGateEvaluationId,
  validateAdversarialCase,
  validateGoldenDatasetEntry,
  validateModuleHealthMetric,
...
const makeArtifactRef = (artifactId: string) =>
  createArtifactReference({
