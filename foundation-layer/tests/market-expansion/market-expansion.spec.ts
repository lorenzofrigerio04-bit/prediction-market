...
import {
  ...
  DerivativeType,
  DeterministicCannibalizationChecker,
  DeterministicExpansionValidator,
  ExpansionValidationStatus,
  FamilyCompatibilityStatus,
  FamilyEditorialCompatibilityAdapter,
  FamilyStatus,
  GenerationStatus,
  MarketFamilyMarketDraftPipelineAdapter,
  MarketFamilyPublicationReadyAdapter,
  MarketFamilyPublishableCandidateAdapter,
  RelationshipStrength,
  RelationshipType,
  SatelliteRole,
  SourceContextType,
  StrategyType,
  createCannibalizationCheckResult,
  createCannibalizationCheckResultId,
  createDerivativeMarketDefinition,
  createDerivativeMarketDefinitionId,
  createExpansionStrategy,
  createExpansionStrategyId,
  createExpansionValidationReport,
  createExpansionValidationReportId,
  createFamilyGenerationResult,
  createFamilyGenerationResultId,
  createFlagshipMarketSelection,
  createFlagshipMarketSelectionId,
  createMarketFamily,
  createMarketFamilyId,
  createMarketRelationship,
  createMarketRelationshipId,
  createSatelliteMarketDefinition,
  createSatelliteMarketDefinitionId,
  validateCannibalizationCheckResult,
  validateDerivativeMarketDefinition,
  validateExpansionStrategy,
  validateExpansionValidationReport,
  validateFamilyGenerationResult,
  validateFlagshipMarketSelection,
  validateMarketExpansionFamilyAggregate,
  validateMarketFamily,
  validateMarketFamilyCompatibility,
  validateMarketRelationship,
  validateSatelliteMarketDefinition,
} from "../../src/market-expansion/index.js";

const makeMarketFamily = () =>
  createMarketFamily({
