...
describe("deterministicDiscoverySignalBuilder", () => {
  ...
  it("builds one DiscoverySignal from single NormalizedDiscoveryItem", () => {
    ...
    const s = signal as import("../../src/discovery-news-engine/entities/discovery-signal.entity.js").DiscoverySignal;
  ...
  it("builds multiple DiscoverySignals from NormalizedDiscoveryPayload", () => {
    ...
    expect((signals as readonly unknown[]).length).toBe(2);
    const report0 = validateDiscoverySignal((signals as readonly unknown[])[0] as import("../../src/discovery-news-engine/entities/discovery-signal.entity.js").DiscoverySignal);
    const report1 = validateDiscoverySignal((signals as readonly unknown[])[1] as import("../../src/discovery-news-engine/entities/discovery-signal.entity.js").DiscoverySignal);
  ...
  it("uses options kindNullable when provided", () => {
    ...
    }) as import("../../src/discovery-news-engine/entities/discovery-signal.entity.js").DiscoverySignal;
