...
import {
  ...
  createEntityNormalizationResult,
  createEventCandidate,
  createEventCandidateId,
  createEventCluster,
  createEventClusterId,
  createEventConflict,
  createEventConflictId,
  createEventGraphNode,
  createEventGraphNodeId,
  createEventRelation,
  createEventRelationId,
  createEvidenceSpan,
  createGraphMetadata,
  ...
  validateDeduplicationDecision,
  validateEntityNormalizationResult,
  validateEventCandidate,
  validateEventCluster,
  validateEventConflict,
  validateEventGraphNode,
  validateEventRelation,
  validateObservationInterpretation,
...
describe("event intelligence validators", () => {
  ...
  it("invalid EventCandidate with missing observations", () => {
    ...
    const report = validateEventCandidate(payload as never);
  ...
  it("invalid CanonicalEvent without supporting candidates", () => {
    ...
    const report = validateCanonicalEvent(payload as never);
    expect(report.isValid).toBe(false);
  ...
  it("relation validation", () => {
    ...
    expect(validateEventRelation(invalidRelation as never).isValid).toBe(false);
  });
  ...
  it("cluster validation", () => {
    ...
    expect(validateEventCluster(invalidCluster as never).isValid).toBe(false);
  });
  ...
  it("entity normalization result validation", () => {
    ...
    expect(validateEntityNormalizationResult(invalidResult as never).isValid).toBe(false);
  });
  ...
  it("event graph node validation", () => {
    ...
    expect(validateEventGraphNode(invalidNode as never).isValid).toBe(false);
  });
