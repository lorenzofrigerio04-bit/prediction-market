...
import {
  ...
  createAdminCreditAdjustmentId,
  createAdjustmentReason,
  createAuditRef,
  createBonusEligibility,
  createBonusEligibilityId,
  createCorrelationId,
  createCreditBalanceSnapshot,
  createCreditBalanceSnapshotId,
  createCreditConsumptionEvent,
  ...
  createOwnerRef,
  createPolicyKey,
  createQuotaEvaluation,
  createQuotaEvaluationId,
  createQuotaPolicy,
  createQuotaPolicyId,
  createRelatedRef,
  createUsageCounter,
...
describe("virtual-credits domain validators", () => {
  ...
  it("2 - invalid VirtualCreditAccount without owner_ref", () => {
    const invalid = { ...buildValidAccount(), owner_ref: "" as ReturnType<typeof createOwnerRef> };
  ...
  it("17/18 - AdminCreditAdjustment valid and missing audit_ref invalid", () => {
    ...
    expect(validateAdminCreditAdjustment({ ...adjustment, audit_ref: "" as ReturnType<typeof createAuditRef> }).isValid).toBe(false);
  });
